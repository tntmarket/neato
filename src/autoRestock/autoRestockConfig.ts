...
export const MIN_PROFIT_TO_BUY_JUNK = getJsonSetting(
    "Min Profit to Buy Junk",
    1000,
);
export const MIN_PROFIT_RATIO_JUNK = getJsonSetting(
    "Min Profit Ratio to Buy Junk",
    0.5,
);

export const MIN_PROFIT_TO_BUY = getJsonSetting("Min Profit to Buy", 2000);
...
export const MAX_COPIES_TO_SHELVE_IF_JUNK = 1;
